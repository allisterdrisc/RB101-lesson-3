...
# Using slice, the non-destructive version of slice!, would return a new string with 
# the same text ("Few things in life are as important as ") but the advice variable
# would remain the same, pointing to the original string
